//This scripts file was used for the postman scripts
//The file has been added so that it can be seen by the markers
...
function sendRequest() {
    pm.sendRequest({
        url: "https://artgallery-team7.herokuapp.com/api/art",
        method: 'GET'
    }, function (err, res) {
